...
<div class="page-container">
		...
		<div class="page-index" style="background-color: #f2f2f2;">
			<div class="page-top _orange-red" style="padding-bottom: 5%">
				...
				<div class="ui basic modal">
				  ...
				  <div class="actions" style="text-align: center;">
				  	...
				  	<a href="<?= '/company/index??server_parent='.$serverParent.'&server_id='.$value['server_id'].'&sort=fraction'; ?>">
				...
				<div class="search-type">
					<div><a href="<?= '/basic-clean/staff?server_parent='.$serverParent.'&server_id='.$serverId.'&sort=fraction'; ?>">服务者</a></div>
			...
			<div class="search-list">
				...
				<a href="/basic-clean/detail?company_id=<?= $model->id;?>&server_id=<?= $serverId; ?>">
