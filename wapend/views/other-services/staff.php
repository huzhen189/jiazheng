			...
			<div class="page-top _orange-red" style="padding-bottom: 5%">
				...
				<div class="ui basic modal">
				  ...
				  <div class="actions" style="text-align: center;">
				  	...
				  	<a href="<?= '/other-services/staff?server_parent='.$serverParent.'&server_id='.$value['server_id'].'&sort=fraction'; ?>">
				...
				<div class="search-type">
					...
					<div><a href="<?= '/other-services/index?server_parent='.$serverParent.'&server_id='.$serverId.'&sort=fraction'; ?>">商家</a></div>
