                         ...
                         if($value->is_main == 1){
                            $html = $html.
                                    '<div class="mian_server_box child">'.
                                        ...
                                        '<div class="staff_name">服务人员: '.
                                                YxStaff::getStaffName($order["yx_staff_id"]).
                                        '</div>'.
                                        '<div class="server_name">服务项目: '.
                                                $value["server_name"].
                                        '</div>'.
                              ...
                              '<div class="order_action child">'.
                                ...
                                switch ($order->order_state) {
                                  case 1: //待支付
                                      ...
                                      $html = $html.Html::a('取消订单', ['returned?order_id='.$order->id], ['class' => 'btn btn-cancel']);
                                      break;
                                  case 2: //待接单
                                      $html = $html.Html::a('取消订单', ['returned?order_id='.$order->id], ['class' => 'btn btn-cancel']);
                                      break;
                                  ...
                                  case 7: //已退款
                                      ...
                                      break;
                                  case 8: //已完成
                                      $html = $html.Html::a('评论', ['payment?id='.$order->id], ['class' => 'btn btn-comment']);
                                      break;
                                  case 9: //拒绝退款
                                      $html = $html.Html::a('重新退款', ['returned?order_id='.$order->id], ['class' => 'btn btn-cancel']);
                                      break;
                                  default:
                                    # code...
                                    break;
