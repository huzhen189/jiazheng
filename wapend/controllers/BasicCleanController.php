		...
		if(Yii::$app->user->identity) {
			...
			if($sort === 'fraction') {
				...
				if($county) {
					$YxCompany = YxCompany::find()->select(['*'])
										->innerjoin('yx_cmp_server', 'yx_cmp_server.company_id=yx_company.id')
											->where(['yx_company.status'=>2,'yx_cmp_server.server_id'=>$serverId,'yx_company.city'=>$user_info['city'],'yx_company.district'=>$county])->orderBy('yx_company.server_price desc');
				}else {
					$YxCompany = YxCompany::find()->select(['*'])
										->innerjoin('yx_cmp_server', 'yx_cmp_server.company_id=yx_company.id')
											->where(['yx_company.status'=>2,'yx_cmp_server.server_id'=>$serverId,'yx_company.city'=>$user_info['city']])->orderBy('yx_company.server_price desc');
				}
			}else {
				$sort = 'fraction';
				if($county) {
			...
			if($sort === 'fraction') {
				...
				if($county) {
					$YxStaff = YxStaff::find()->select(['*'])
										->innerjoin('yx_company', 'yx_company.id=yx_staff.company_id')
										->innerjoin('yx_staff_server', 'yx_staff_server.staff_id=yx_staff.staff_id')
											->where(['yx_staff.staff_state'=>1,'yx_staff_server.server_id'=>$serverId,'yx_company.city'=>$user_info['city'],'yx_company.district'=>$county])->orderBy('yx_staff.server_price desc');
				}else {
					$YxStaff = YxStaff::find()->select(['*'])
										->innerjoin('yx_company', 'yx_company.id=yx_staff.company_id')
										->innerjoin('yx_staff_server', 'yx_staff_server.staff_id=yx_staff.staff_id')
											->where(['yx_staff.staff_state'=>1,'yx_staff_server.server_id'=>$serverId,'yx_company.city'=>$user_info['city']])->orderBy('yx_staff.server_price desc');
				}
			...
			if($sort === 'fraction') {
				...
				if($province>0 && $city==0) {
					$YxStaff = YxStaff::find()->select(['*'])
										->innerjoin('yx_company', 'yx_company.id=yx_staff.company_id')
										->innerjoin('yx_staff_server', 'yx_staff_server.staff_id=yx_staff.staff_id')
											->where(['yx_staff.staff_state'=>1,'yx_staff_server.server_id'=>$serverId,'yx_company.province'=>$province])->orderBy('yx_staff.server_price desc');
				}elseif ($province>0 && $city>0) {
					$YxStaff = YxStaff::find()->select(['*'])
										->innerjoin('yx_company', 'yx_company.id=yx_staff.company_id')
										->innerjoin('yx_staff_server', 'yx_staff_server.staff_id=yx_staff.staff_id')
											->where(['yx_staff.staff_state'=>1,'yx_staff_server.server_id'=>$serverId,'yx_company.province'=>$province,'yx_company.city'=>$city])->orderBy('yx_staff.server_price desc');
				}else {
					$YxStaff = YxStaff::find()->select(['*'])
										->innerjoin('yx_company', 'yx_company.id=yx_staff.company_id')
										->innerjoin('yx_staff_server', 'yx_staff_server.staff_id=yx_staff.staff_id')
											->where(['yx_staff.staff_state'=>1,'yx_staff_server.server_id'=>$serverId])->orderBy('yx_staff.server_price desc');
				}
