				...
				<div class="condition-inner">
					...
					<div class="condition-right">
						<ul>
							<li>
								<?php
										echo '<a href="/other-services/index?server_id='.$serverId.'&sort=default" class="header-title">商家</a>';
								?>
							</li>
							<li class="active">
								<a href="#">服务者</a>
			...
			<?php foreach ($models as $model): ?>
				<div class="staff-one">
					...
					<div class="staff-info">
						...
						<div class="detail">
							<a class="btn btn-url" href="http://yuanxiangwu.com/staff?staff_id=<?= $model->staff_id?>">查看详情</a>
						</div>
					</div>
				</div>
			<?php endforeach; ?>
