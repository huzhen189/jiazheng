...
<div class="header">
    <div class="tools">
        <textarea id="clipboard">ArgumentCountError: Too few arguments to function yii\db\BaseActiveRecord::findOne(), 0 passed in /home/yuanxiang/yii2/common/models/YxOrder.php on line 259 and exactly 1 expected in /home/yuanxiang/yii2/vendor/yiisoft/yii2/db/BaseActiveRecord.php:110
Stack trace:
#0 /home/yuanxiang/yii2/common/models/YxOrder.php(259): yii\db\BaseActiveRecord::findOne()
#1 /home/yuanxiang/yii2/backend/controllers/TokenController.php(42): common\models\YxOrder::finishOrder(&#039;ch_rnfb5SerT4WP...&#039;, &#039;C18041605B03001...&#039;)
#2 [internal function]: backend\controllers\TokenController-&gt;actionFinish_order()
#3 /home/yuanxiang/yii2/vendor/yiisoft/yii2/base/InlineAction.php(57): call_user_func_array(Array, Array)
#4 /home/yuanxiang/yii2/vendor/yiisoft/yii2/base/Controller.php(157): yii\base\InlineAction-&gt;runWithParams(Array)
#5 /home/yuanxiang/yii2/vendor/yiisoft/yii2/base/Module.php(528): yii\base\Controller-&gt;runAction(&#039;finish_order&#039;, Array)
#6 /home/yuanxiang/yii2/vendor/yiisoft/yii2/web/Application.php(103): yii\base\Module-&gt;runAction(&#039;token/finish_or...&#039;, Array)
#7 /home/yuanxiang/yii2/vendor/yiisoft/yii2/base/Application.php(386): yii\web\Application-&gt;handleRequest(Object(yii\web\Request))
#8 /home/yuanxiang/yii2/backend/web/index.php(17): yii\base\Application-&gt;run()
#9 {main}</textarea>
        ...
        <a href="https://stackoverflow.com/search?q=Too+few+arguments+to+function+yii%5Cdb%5CBaseActiveRecord%3A%3AfindOne%28%29%2C+0+passed+in+%2Fhome%2Fyuanxiang%2Fyii2%2Fcommon%2Fmodels%2FYxOrder.php+on+line+259+and+exactly+1+expected" title="Search error on Stackoverflow" target="_blank">
        ...
        <a href="https://www.google.com/search?q=Too+few+arguments+to+function+yii%5Cdb%5CBaseActiveRecord%3A%3AfindOne%28%29%2C+0+passed+in+%2Fhome%2Fyuanxiang%2Fyii2%2Fcommon%2Fmodels%2FYxOrder.php+on+line+259+and+exactly+1+expected" title="Search error on Google" target="_blank">
        ...
        <h1><span>ArgumentCountError</span></h1>
            <h2>Too few arguments to function yii\db\BaseActiveRecord::findOne(), 0 passed in /home/yuanxiang/yii2/common/models/YxOrder.php on line 259 and exactly 1 expected</h2>
...
<div class="element-wrap">
    <div class="element">
        ...
        <span class="text">in /home/yuanxiang/yii2/vendor/yiisoft/yii2/db/BaseActiveRecord.php</span>
        <span class="at">
            at line                <span class="line">110</span>
        </span>
                </div>
</div>
        <div class="code-wrap">
        ...
        <div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div>            <div class="code">
            <span class="lines-item">101</span><span class="lines-item">102</span><span class="lines-item">103</span><span class="lines-item">104</span><span class="lines-item">105</span><span class="lines-item">106</span><span class="lines-item">107</span><span class="lines-item">108</span><span class="lines-item">109</span><span class="lines-item">110</span><span class="lines-item">111</span><span class="lines-item">112</span><span class="lines-item">113</span><span class="lines-item">114</span><span class="lines-item">115</span><span class="lines-item">116</span><span class="lines-item">117</span><span class="lines-item">118</span><span class="lines-item">119</span>                <pre>
...
<div class="element-wrap">
    <div class="element">
        ...
        <span class="text">in /home/yuanxiang/yii2/common/models/YxOrder.php</span>
        <span class="at">
            at line                <span class="line">259</span>
        </span>
                        <span class="call">
                &ndash;                    <a href="http://www.yiiframework.com/doc-2.0/yii-db-baseactiverecord.html#findOne()-detail" target="_blank">yii\db\BaseActiveRecord::findOne</a>()                </span>
                </div>
</div>
        <div class="code-wrap">
        <div class="error-line"></div>
        <div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div>            <div class="code">
            <span class="lines-item">253</span><span class="lines-item">254</span><span class="lines-item">255</span><span class="lines-item">256</span><span class="lines-item">257</span><span class="lines-item">258</span><span class="lines-item">259</span><span class="lines-item">260</span><span class="lines-item">261</span><span class="lines-item">262</span><span class="lines-item">263</span><span class="lines-item">264</span><span class="lines-item">265</span>                <pre>
                                $timeDatas[$i] = 0;
        }
    }
    return $timeDatas;
...
public static function finishOrder($pingId,$order_no){
    $orders = YxOrder::findOne()-&gt;where([&quot;order_no&quot; =&gt; $order_no]);
...
<div class="element-wrap">
    <div class="element">
        ...
        <span class="text">in /home/yuanxiang/yii2/backend/controllers/TokenController.php</span>
        <span class="at">
            at line                <span class="line">42</span>
        </span>
                        <span class="call">
                &ndash;                    common\models\YxOrder::finishOrder(<span class="string">'ch_rnfb5SerT4WPvPqrfHWbXDKC'</span>, <span class="string">'C18041605B03001005'</span>)                </span>
                </div>
</div>
        <div class="code-wrap">
        <div class="error-line"></div>
        <div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div>            <div class="code">
            <span class="lines-item">36</span><span class="lines-item">37</span><span class="lines-item">38</span><span class="lines-item">39</span><span class="lines-item">40</span><span class="lines-item">41</span><span class="lines-item">42</span><span class="lines-item">43</span><span class="lines-item">44</span><span class="lines-item">45</span><span class="lines-item">46</span><span class="lines-item">47</span><span class="lines-item">48</span>                <pre>
...
<div class="element-wrap">
    <div class="element">
        ...
        <span class="at">
                        ...
                        <span class="call">
                                    backend\controllers\TokenController::actionFinish_order()                </span>
                </div>
</div>
</li>
<li class=" call-stack-item"
...
<div class="element-wrap">
    <div class="element">
        ...
        <span class="text">in /home/yuanxiang/yii2/vendor/yiisoft/yii2/base/InlineAction.php</span>
        <span class="at">
            at line                <span class="line">57</span>
        </span>
                        <span class="call">
                &ndash;                    call_user_func_array([<span class="title">backend\controllers\TokenController</span>, <span class="string">'actionFinish_order'</span>], [])                </span>
                </div>
</div>
        <div class="code-wrap">
        <div class="error-line"></div>
        <div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div>            <div class="code">
            <span class="lines-item">51</span><span class="lines-item">52</span><span class="lines-item">53</span><span class="lines-item">54</span><span class="lines-item">55</span><span class="lines-item">56</span><span class="lines-item">57</span><span class="lines-item">58</span><span class="lines-item">59</span>                <pre>
...
<div class="element-wrap">
    <div class="element">
        ...
        <span class="text">in /home/yuanxiang/yii2/vendor/yiisoft/yii2/base/Controller.php</span>
        <span class="at">
            at line                <span class="line">157</span>
        </span>
                        <span class="call">
                &ndash;                    <a href="http://www.yiiframework.com/doc-2.0/yii-base-inlineaction.html#runWithParams()-detail" target="_blank">yii\base\InlineAction::runWithParams</a>([])                </span>
                </div>
</div>
        <div class="code-wrap">
        <div class="error-line"></div>
        <div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div>            <div class="code">
            <span class="lines-item">151</span><span class="lines-item">152</span><span class="lines-item">153</span><span class="lines-item">154</span><span class="lines-item">155</span><span class="lines-item">156</span><span class="lines-item">157</span><span class="lines-item">158</span><span class="lines-item">159</span><span class="lines-item">160</span><span class="lines-item">161</span><span class="lines-item">162</span><span class="lines-item">163</span>                <pre>
                        }
...
<div class="element-wrap">
    <div class="element">
        ...
        <span class="text">in /home/yuanxiang/yii2/vendor/yiisoft/yii2/base/Module.php</span>
        <span class="at">
            at line                <span class="line">528</span>
        </span>
                        <span class="call">
                &ndash;                    <a href="http://www.yiiframework.com/doc-2.0/yii-base-controller.html#runAction()-detail" target="_blank">yii\base\Controller::runAction</a>(<span class="string">'finish_order'</span>, [])                </span>
                </div>
</div>
        <div class="code-wrap">
        <div class="error-line"></div>
        <div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div>            <div class="code">
            <span class="lines-item">522</span><span class="lines-item">523</span><span class="lines-item">524</span><span class="lines-item">525</span><span class="lines-item">526</span><span class="lines-item">527</span><span class="lines-item">528</span><span class="lines-item">529</span><span class="lines-item">530</span><span class="lines-item">531</span><span class="lines-item">532</span><span class="lines-item">533</span><span class="lines-item">534</span>                <pre>
...
<div class="element-wrap">
    <div class="element">
        ...
        <span class="text">in /home/yuanxiang/yii2/vendor/yiisoft/yii2/web/Application.php</span>
        <span class="at">
            at line                <span class="line">103</span>
        </span>
                        <span class="call">
                &ndash;                    <a href="http://www.yiiframework.com/doc-2.0/yii-base-module.html#runAction()-detail" target="_blank">yii\base\Module::runAction</a>(<span class="string">'token/finish_order'</span>, [])                </span>
                </div>
</div>
        <div class="code-wrap">
        <div class="error-line"></div>
        <div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div>            <div class="code">
            <span class="lines-item">97</span><span class="lines-item">98</span><span class="lines-item">99</span><span class="lines-item">100</span><span class="lines-item">101</span><span class="lines-item">102</span><span class="lines-item">103</span><span class="lines-item">104</span><span class="lines-item">105</span><span class="lines-item">106</span><span class="lines-item">107</span><span class="lines-item">108</span><span class="lines-item">109</span>                <pre>
...
<div class="element-wrap">
    <div class="element">
        ...
        <span class="text">in /home/yuanxiang/yii2/vendor/yiisoft/yii2/base/Application.php</span>
        <span class="at">
            at line                <span class="line">386</span>
        </span>
                        <span class="call">
        ...
        <div class="error-line"></div>
        <div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div>            <div class="code">
            <span class="lines-item">380</span><span class="lines-item">381</span><span class="lines-item">382</span><span class="lines-item">383</span><span class="lines-item">384</span><span class="lines-item">385</span><span class="lines-item">386</span><span class="lines-item">387</span><span class="lines-item">388</span><span class="lines-item">389</span><span class="lines-item">390</span><span class="lines-item">391</span><span class="lines-item">392</span>                <pre>
                    {
    try {
...
<div class="element-wrap">
    <div class="element">
        ...
        <span class="text">in /home/yuanxiang/yii2/backend/web/index.php</span>
        <span class="at">
        ...
        <div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div><div class="hover-line"></div>            <div class="code">
            <span class="lines-item">11</span><span class="lines-item">12</span><span class="lines-item">13</span><span class="lines-item">14</span><span class="lines-item">15</span><span class="lines-item">16</span><span class="lines-item">17</span>                <pre>
...
<div class="footer">
    ...
    <p class="timestamp">2018-04-16, 16:24:24</p>
    <p><a href="http://nginx.org/" target="_blank">nginx/1.12.2</a></p>
    <p><a href="http://yiiframework.com/">Yii Framework</a>/<a href="http://github.com/yiisoft/yii2/" target="_blank">2.0.16-dev</a></p>
</div>
