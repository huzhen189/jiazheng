	...
	<div class="store-list">
		...
		<div class="staff">
			<?php foreach ($models as $model): ?>
				<div class="staff-one" style="height: 275px;">
					<div class="img">
	...
	window.onload = function() {
	  ...
	  $(".staff-one").mouseleave(function(){
		...
		$(".sequence").click(function(event) {
			// 切换服务
			if(userIs == 1) {
				window.location.href = "/basic-clean/staff?server_parent="+$(".select-service").attr('server_parent')+"&server_id="+$(".select-service option:selected").attr('value')+"&county="+$("#area_list option:selected").attr('value')+"&sort="+$(this).attr('data-sort');
			}else {
				window.location.href = "/basic-clean/staff?server_parent="+$(".select-service").attr('server_parent')+"&server_id="+$(".select-service option:selected").attr('value')+"&province="+$("#province_list option:selected").attr('value')+"&city="+$("#city_list option:selected").attr('value')+"&sort="+$(this).attr('data-sort');
			}
		});
		$(".select-service").change(function(event) {
			...
			if(userIs == 1) {
				...
				window.location.href = "/basic-clean/staff?server_parent="+$(".select-service").attr('server_parent')+"&server_id="+$(".select-service option:selected").attr('value')+"&province="+$("#province_list option:selected").attr('value')+"&city="+$("#city_list option:selected").attr('value')+"&sort=fraction";
			}
